...
export const en = {
  ...
  settings: {
    ...
    language: 'Language',
    account: 'Account',
    region: 'Timezone and currency',
    timezone: 'Timezone',
    timezoneHelp: 'Decides when each day starts. Your tracking start date ({{date}}) does not change.',
    currency: 'Currency',
    currencyHelp: 'Used for new entries. Past entries keep the currency they were logged in.',
    saved: 'Saved.',
