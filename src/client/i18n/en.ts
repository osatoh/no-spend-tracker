...
export const en = {
  ...
  settings: {
    ...
    dailyBudget: 'Daily budget ({{currency}})',
    dailyBudgetHelp:
      'How much you usually spend in a day. Used to estimate your savings. It is cleared when you change the currency.',
    save: 'Save',
    saved: 'Saved.',
  ...
  errors: {
    ...
    invalid_budget: 'Enter a daily budget of at least 1, or leave it empty.',
    rates_unavailable: "Exchange rates aren't available right now. Please try again later.",
